...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/unidic-lite-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11847&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/unidic-lite-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `unidic-lite` can be installed with:

```
conda install unidic-lite
```

It is possible to list all of the versions of `unidic-lite` available on your platform with:
